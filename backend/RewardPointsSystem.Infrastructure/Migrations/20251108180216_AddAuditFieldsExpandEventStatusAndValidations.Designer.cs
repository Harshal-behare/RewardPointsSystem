...
namespace RewardPointsSystem.Infrastructure.Migrations
{
    ...
    [Migration("20251108180216_AddAuditFieldsExpandEventStatusAndValidations")]
    partial class AddAuditFieldsExpandEventStatusAndValidations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RewardPointsSystem.Domain.Entities.Accounts.PointsTransaction", b =>
                {
                    ...
                    SqlServerIndexBuilderExtensions.IncludeProperties(b.HasIndex("UserId", "Timestamp"), new[] { "BalanceAfter", "Points" });
